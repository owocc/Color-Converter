      ...
      <div className="max-w-7xl mx-auto">
        <header className="text-center mb-8">
          ...
          <p className="mt-2 text-lg text-gray-400">
            Instantly convert HEX, RGB, and HSL colors to the OKLCH color space.
          </p>
        </header>
        <ColorConverter />
         <footer className="text-center mt-8 text-gray-500 text-sm">
          <p>Built for modern CSS workflows. Paste your variables and get instant OKLCH conversions.</p>
        </footer>
      </div>
    </main>
  );
